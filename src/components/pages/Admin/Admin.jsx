...
const Admin = () => {
  ...
  const SectionHeader = ({ title, description }) => (
    <div style={{
      ...
      {description && (
        <p style={{ margin: "8px 0 0", color: "#64748b", fontSize: 14 }}>{description}</p>
      )}
    </div>
  );
  ...
  const Placeholder = ({ label }) => (
    <div style={{ padding: 20 }}>
      <div style={{
        ...
        <p style={{ margin: 0, color: "#475569" }}>{label} 페이지가 곧 제공됩니다.</p>
      </div>
    </div>
  );
  ...
  const renderSection = () => {
    switch (activeSection) {
      case "dashboard":
        return (
          <>
            <SectionHeader title="대시보드" description="핵심 지표를 한눈에 확인하세요" />
            <DashboardSection />
          </>
        );
      case "users":
        return (
          <>
            <SectionHeader title="사용자 관리" description="사용자 목록과 권한을 관리합니다" />
      ...
      case "contents":
        return (
          <>
            <SectionHeader title="콘텐츠 관리" description="게시물과 자산을 관리합니다" />
      ...
      case "orders":
        return (
          <>
            <SectionHeader title="주문/거래 관리" description="주문 흐름과 상태를 모니터링합니다" />
      ...
      case "reports":
        return (
          <>
            <SectionHeader title="통계 및 리포트" description="서비스 데이터를 분석합니다" />
      ...
      case "settings":
        return (
          <>
            <SectionHeader title="시스템 설정" description="환경 설정과 통합을 관리합니다" />
      ...
      case "support":
        return (
          <>
            <SectionHeader title="고객 지원 관리" description="문의와 티켓을 처리합니다" />
      ...
      case "security":
        return (
          <>
            <SectionHeader title="보안 관리" description="접근 제어와 로그를 확인합니다" />
      ...
      case "ui":
        return (
          <>
            <SectionHeader title="UI / 모달 데모" description="공통 컴포넌트 데모 모음" />
            <UISection />
          </>
        );
      default:
  ...
  return (
    <div style={{ display: "flex", width: "100%" }}>
      ...
      >
        <div style={{ fontWeight: 700, marginBottom: 12, color: "#0f172a" }}>관리자</div>
        <div style={{ display: "grid", gap: 4 }}>
          ...
          <div style={{ height: 8 }} />
          <div style={{ fontSize: 12, color: "#64748b", padding: "6px 8px" }}>데모</div>
          <SidebarLink id="ui" label="UI / 모달" emoji="🧩" />
        </div>
      </aside>

      <section style={{ flex: 1, background: "#f1f5f9", minHeight: "100vh" }}>
        {renderSection()}
      </section>
    </div>
  );
