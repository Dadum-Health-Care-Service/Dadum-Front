...
export default function Shop() {
  ...
  const products = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1594736797933-d0c0a0b0b0b0?w=400&h=300&fit=crop&crop=center',
      badge: 'SALE',
  ...
  return (
    <div className={styles.shopContainer}>
      ...
      <div className={styles.shopHeader}>
        <h1 className={styles.shopTitle}>🏪 MOG Shop</h1>
        <p className={styles.shopSubtitle}>당신의 운동을 더욱 특별하게 만들어줄 제품들을 만나보세요</p>
        <div className={styles.shopActions}>
          <ButtonComponent 
            variant="outline" 
            onClick={() => window.dispatchEvent(new CustomEvent('tabChange', { detail: 'orders' }))}
          >
            📋 주문 내역
          </ButtonComponent>
        </div>
      ...
      {filteredProducts.length === 0 && (
        <div className={styles.emptyState}>
          <h4 className={styles.emptyStateTitle}>😔 해당 카테고리의 상품이 없습니다</h4>
