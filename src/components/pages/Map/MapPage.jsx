...
export default function MapPage() {
  ...
  const { gatherings, fetchGatherings, syncGatheringParticipants } =
    useGatherings();
  ...
  useEffect(() => {
    if (searchResults.length > 0) {
      const facilitiesWithDistance = addDistanceToResults(
        searchResults,
        userLocation
      );
  ...
  // 시설 상세 정보 토글
  const toggleFacilityDetails = useCallback(
    (facilityId) => {
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.mapHeader}>
        <h1 className={styles.mapTitle}>🏃‍♂️ Wannabe healthy</h1>
                  ...
                  <div className={styles.mapSection}>
                    ...
                    <div className={styles.mapSection}>
                      <div className={styles.mapContainer}>
                        ...
                        {mapError && (
                          <div className={styles.errorOverlay}>{mapError}</div>
                        )}
                          ...
                          {facilities.map((facility, index) => (
                            ...
                            >
                              ...
                              <div className={styles.facilityInfo}>
                                ...
                                <p>
                                  <strong>주소:</strong> {facility.address_name}
                                </p>
                                {facility.phone && (
                                  <p>
                                    <strong>전화:</strong> {facility.phone}
                                  </p>
                                )}
                              </div>
                              ...
                              <div className={styles.facilityActions}>
                                <ButtonComponent
                                  onClick={() =>
                                    toggleFacilityDetails(facility.id || index)
                                  }
                                  size="small"
                                >
                                ...
                                {facility.place_url && (
                                  <ButtonComponent
                                    onClick={() =>
                                      window.open(facility.place_url, "_blank")
                                    }
                                    size="small"
                                  >
                                    지도에서 보기
                              ...
                              {expandedFacility === (facility.id || index) && (
                                <div className={styles.facilityDetails}>
                                  ...
                                  <p>
                                    <strong>카테고리 그룹:</strong>{" "}
                                    {facility.category_group_name}
                                  </p>
                                  <p>
                                    <strong>좌표:</strong> {facility.y},{" "}
                                    {facility.x}
                                  </p>
                                </div>
                              )}
